...
export class FinancialInstitutionService {
  ...
  public getById(id: number): Observable<any> {
    return this.http
      .get(this.baseUrl + "FinancialInstitution/GetById/" + id, {
  ...
  public create(model: any): Observable<any> {
    return this.http
      .post(this.baseUrl + "FinancialInstitution/Create", model, {
        headers: new HttpHeaders()
          .set("Content-Type", "application/json")
          .set(
            "Authorization",
  ...
  public update(model: any): Observable<any> {
    return this.http
      .post(this.baseUrl + "FinancialInstitution/Update", model, {
        headers: new HttpHeaders()
          .set("Content-Type", "application/json")
          .set(
            "Authorization",
  ...
  public getPaginated(model: any): Observable<any> {
    return this.http
      .post(this.baseUrl + "FinancialInstitution/GetPaginated", model, {
        headers: new HttpHeaders()
          .set("Content-Type", "application/json")
          .set(
            "Authorization",
  ...
  public getAll(): Observable<any> {
    return this.http
      .get(this.baseUrl + "FinancialInstitution", {
        headers: new HttpHeaders()
          .set("Content-Type", "application/json")
          .set(
            "Authorization",
