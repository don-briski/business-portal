...
import { UntypedFormGroup, FormControl, Validators, AbstractControl, ValidationErrors, FormBuilder } from '@angular/forms';
...
@Component({
  selector: 'app-short-term-placement-view-page',
  templateUrl: './short-term-placement-view-page.component.html',
  styleUrls: ['./short-term-placement-view-page.component.scss']
})
export class ShortTermPlacementViewPageComponent implements OnInit, OnDestroy {
