(function ($) {
  ...
  var dtModule = {
    ...
    init: function () {
      ...
      $(document).on("layout-changed", function (event) {
        dtModule.calculateHeight();
      });
    },
    calculateHeight: function () {
      ...
      var bodyVerticalPadding =
        parseInt(this.docBody.css("padding-top")) +
        parseInt(this.docBody.css("padding-bottom"));

      var h_Height = this.mainHeader.outerHeight();
      var pc_Padding =
        parseInt(this.pageContent.css("padding-top")) +
        parseInt(this.pageContent.css("padding-bottom"));
      var pm_Margin =
        parseInt(this.appModule.css("margin-top")) +
        parseInt(this.appModule.css("margin-bottom"));
      ...
      var th =
        h_Height + pc_Padding + ph_Height + f_Height + bodyVerticalPadding;
      ...
      var sh_height = this.appModuleSidebar
        .find(".dt-module__sidebar-header")
        .outerHeight(true);
      var sc_height = moduleHeight - sh_height - bodyVerticalPadding;

      this.appModuleSidebar
        .find(".dt-module__sidebar-content")
        .height(sc_height);

      if (this.appModule.hasClass("dt-module--chat")) {
        if (w_Width > 767) {
          var tabHeaderHeight = this.appModuleSidebar
            .find(".dt-module__sidebar-content > .card-header")
            .outerHeight(true);
        ...
        this.appModuleSidebar
          ...
          .height(sc_height - tabHeaderHeight - bodyVerticalPadding);
      }
    },
  };

  $(document).on("loader-hide", function (event) {
    dtModule.init();
  });
})(jQuery);
